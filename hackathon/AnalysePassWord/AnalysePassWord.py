...
def filtered_list(list, occurence):
    return [i for i in list if i != occurence]
        ...
        while (i < len(password_in)):
            ...
            if (next_letter == -2):
                ...
                if (len(password_out[-1]) != 0):
                    password_out[-1] = password_out[-1][0:-1]
                ...
                if (shift):
                    ...
                    password_out[-1] = password_out[-1] + next_letter.lower()
                shift = False
